...
There are seven people-generated spaces found within Hougang, four outdoor spaces and three spaces found in void decks. Outdoor spaces are defined as spaecs beyond the boundaries of a HDB block and can be comprised of both sheltered and non-sheltered locations. There were many forms of gardens observed in Hougang, each with its own variety. However, the creation of these spaces are ambiguous; it is not clear if they are initiated by state instruments or the communities themselves. Hence, more conversations  with residents of the gardens are needed to develop a clearer understanding on how they fit within the realm of people-generated spaces.
