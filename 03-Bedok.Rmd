...
```{r message=FALSE,echo=FALSE,warning=FALSE, out.width = '50%', fig.show='hold',fig.align='center', fig.cap="(Left, BD_O_06) Stacked chairs with a makeshift storage area and hanging tools by the tree with a potted garden nearby creates an expansive and invested space by the residents (Right, BD_O_07) Foldable tables and chairs set up under a tree, with a resident enjoying his time. A sitting spot for potential betters at the Singapore Pools"}
...
```{r message=FALSE,echo=FALSE,warning=FALSE, out.width = '50%', fig.show='hold',fig.align='center', fig.cap="(Left, BD_V_03) Wooden and plastic chairs arranged nicely along the wall, for a much larger gathering than the intended 6-seater provided table. Chinese decorations hung around with a clock nearby, giving an impression of a space where people passed the time. (Right, BD_V_09) More seating provided through wooden and plastic chairs beside a minimart space, with rags and containers (unseen in the photo) 'decorating' the area."}
